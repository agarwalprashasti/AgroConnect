...
if(isset($_POST['login_btn'])){
	...
	$query="select * from register where aadhar='$aadhar' and password='$password'";
    ...
    {
        echo "<script>alert('Wrong aadhar no / password')</script>";
...
<body>
  ...
  <div class="login">
    ...
    <div class="login-form">
      ...
      <h3>Aadhar no.</h3>
      <input type="text" placeholder="Enter your aadhar no" name="aadhar" required/><br>
      <h3>Password</h3>
      ...
      <br>
      <a class="sign-up" href="register_farmer.php">Sign Up instead?</a>
      <br>
